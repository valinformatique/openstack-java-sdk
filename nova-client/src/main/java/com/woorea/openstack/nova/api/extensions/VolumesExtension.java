...
import com.woorea.openstack.nova.model.VolumeQuotaDefaults;
...
public class VolumesExtension {
    ...
    public class UploadToImage extends OpenStackRequest<Void> {
        ...
        public UploadToImage(VolumeForImageCreate volumeForImageCreate) {
            super(CLIENT, HttpMethod.POST, new StringBuilder("/volumes/").append(volumeForImageCreate.getVolumeId())
                    .append("/action"),
